...
const Graph = struct {
    ...
    fn countPaths(self: *@This()) !u32 {
        var helper = try struct {
            ...
            fn init(alloc: std.mem.Allocator, g: *const Graph) !@This() {
